...
class Advan extends Entity{
	...
	protected function _customUploadImg($file = array()){
		if( is_array($file) || is_object($file) ){
			...
			$oldPath = WWW_ROOT.'img'.DS.'advans'.DS.$fileName;
			$oldPathThumb = WWW_ROOT.'img'.DS.'advans'.DS.'thumbs'.DS.$fileName;
			...
			$path = WWW_ROOT . 'img'.DS.'advans' .DS. $fileName;
	...
	protected function _genNameFile($ext){
		...
		if(is_file(WWW_ROOT . 'img'.DS.'advans'.DS. $name)){
