...
<head>
    ...
    <link type="image/x-icon" href="/img/fav-icon.ico" rel="shortcut icon">
    <link type="image/x-icon" href="/img/fav-icon.ico" rel="icon">
    <link rel="stylesheet" href="/css/slick.css">
    <link rel="stylesheet" href="/css/slick-theme.css">
    <link rel="stylesheet" href="/css/global.css">
    <link rel="stylesheet" href="/css/style.css?v=70">

    <meta name="google-site-verification" content="H0Ymwl8NGTkucJQpSX-IYT3cGBF_HPseoiNNTJgdd88" />

    <!-- Global site tag (gtag.js) - Google Analytics -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-236234537-1"></script>
    <script>
    ...
    <noscript>
        <div><img src="https://mc.yandex.ru/watch/89820511" style="position:absolute; left:-9999px;" alt="" /></div>
    </noscript>
    <!-- /Yandex.Metrika counter -->
    ...
    <script>
        ...
        })(window, document, 'script', 'dataLayer', 'GTM-TSPWK25');
...
<body>
    ...
    <!-- <div class="popup">
        ...
        <?= $this->Form->create(null, array('class' => 'form', 'action' => '/requests/send')) ?>
                <div class="popup__box-wrapper">
                    <div class="popup__box-title">Оставить заявку</div>
                    <div class="popup__box-col">
                        <span>Ваше Имя</span>
                        <input type="name" name="name" placeholder="Ваше Имя" class="popup__box-input">
                    </div>
                    <div class="popup__box-col">
                        <span>Ваш телефон</span>
                        <input type="tel" name="phone" placeholder="8 (---) --- -- --" class="popup__box-input">
                    </div>
                    <div class="popup__box-col">
                        <span>Ваш вопрос</span>
                        <textarea name="message" placeholder="Ваш вопрос..." class="popup__box-input textarea"></textarea>
                    </div>
    ...
    <div class="form_loader" id="form_loader">
   ...
   <div class="alert--fixed box-size <?= ( isset($msg) && $msg[0]['message'] && $msg_type) ? $msg_type : '' ?>">
       <div class="alert--content alert--width alert--block box-size">
           <div class="alert--img">
               <div class="alert--img__item active box-size">
                   <sv g version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
               ...
               <div class="alert--img__item warning box-size">
                   <sv g height="512pt" viewBox="0 -18 512.00043 512" width="512pt" xmlns="http://www.w3.org/2000/svg"><path d="m241 116h30v165h-30zm0 0"/>
               ...
               <div class="alert--img__item error box-size">
                   ...
                   <sv g class="box-size" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
    ...
    <div class="alert--x alert--close box-size">
        <sv g class="box-size" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
            xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 284.559 284.559"
            style="enable-background:new 0 0 284.559 284.559;" xml:space="preserve">
